...
Reserved values such as `xterm`, `libghostty`, and `vte` are recognized for future backends. Unsupported kernels fail explicitly instead of silently falling back.
