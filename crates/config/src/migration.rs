...
pub const CURRENT_CONFIG_VERSION: &str = "20260313.1";
...
fn migrations() -> &'static [Migration] {
  &[
    ...
    Migration {
      ...
      to_version: "20260313.1",
      migrate: migrate_v20260306_1_to_20260313_1,
    },
  ]
}
...
/// Add restore_sessions configuration support.
fn migrate_v20260306_1_to_20260313_1(value: &mut Value) {
  if let Value::Table(table) = value {
    if !table.contains_key("restore_sessions") {
      table.insert("restore_sessions".to_string(), Value::Boolean(false));
    }
    table.insert(
      "version".to_string(),
      Value::String("20260313.1".to_string()),
    );
  }
}
...
"#,
  ...
  #[test]
  fn migrate_20260306_adds_restore_sessions() {
    let mut config: Value = toml::from_str(
      r#"
version = "20260306.1"
theme = "one"
