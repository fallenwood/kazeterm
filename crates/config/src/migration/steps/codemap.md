...
| `20260512.1 → 20260901.1` | Creates/populates `[animation]` without overwriting existing values: `enabled = true`, `duration_ms = 180`, `frame_interval_ms = 15`, `easing = "ease_in_out"`, and `fade_start_opacity = 0.82`. |
