...
- Defaults are enabled, 180 ms total, a requested 15 ms frame interval, `ease_in_out`, and 0.82 fade-start opacity. Timing/frame count and opacity are clamped by `AnimationConfig`; disabled or zero-duration transitions apply their final state immediately.
